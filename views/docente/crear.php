...
<head>
    ...
    <style>
        ...
        .card-header-custom {
            /* Usamos un verde para "Crear" para diferenciarlo del azul de "Editar", 
               o puedes usar el mismo azul si prefieres uniformidad. 
               Aquí puse el mismo azul del anterior para mantener tu estilo. */
