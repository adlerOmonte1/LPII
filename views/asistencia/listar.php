...
<div class="container mt-5">
    ...
    <h2>
        <span class="title-box">Listado de Asistencias</span>
    </h2>
        ...
        <div class="col-md-6">
            <?php if($_SESSION['perfil'] === 'administrador'): ?>
                <a href="crear.php" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-1"></i> Añadir Asistencia
                </a>
            <?php endif; ?>
        </div>
        <div class="col-md-6">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <?php else: foreach($resultado as $a): ?>
                    <tr>
                        ...
                        <td>
                            <?php if($_SESSION['perfil'] === 'administrador'): ?>
                                <a href="editar.php?id=<?= $a['idAsistencia']; ?>" class="btn btn-warning btn-sm">
                                    <i class="bi bi-pencil-square"></i> Editar
                                </a>
                                <a href="../../controllers/AsistenciaController.php?action=eliminar&id=<?= $a['idAsistencia']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Seguro de eliminar?');">
