            ...
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <div class="card-header card-header-custom p-4 rounded-top-3">
                    <h3 class="mb-0 text-center">
                        <i class="bi bi-journal-plus me-2"></i>Registrar Nueva Matrícula
                    </h3>
                </div>
                ...
                <div class="card-body p-4">
                    <form action="../../controllers/MatriculaController.php" method="POST">
                        ...
                        <h5 class="text-primary mb-3 border-bottom pb-2">Datos de Matrícula</h5>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Fecha de Matrícula</label>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="estado" placeholder="Activo / Retirado / Pendiente" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" class="form-control" name="codigoEstudiante" required>
                        </div>
